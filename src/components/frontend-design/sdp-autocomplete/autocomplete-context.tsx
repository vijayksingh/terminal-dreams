...
import {
  ...
  trieInsert,
  searchTerms,
} from "./engine/prefix-trie";

export type { TrieNode, TrieState };
...
// ── Trie data structure imported from engine/prefix-trie ──────────────────
...
// ── Mock search data imported from engine/prefix-trie ──────────────────
