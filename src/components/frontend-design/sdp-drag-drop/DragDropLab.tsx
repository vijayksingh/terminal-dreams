...
function KanbanBoard() {
  const {
    ...
    toggleSelectItem, moveItemKeyboard,
...
function KanbanColumn({ zone, canDrag, showKeyboard, announce }: {
  zone: DropZone;
  canDrag: boolean;
...
function KanbanItem({ item, zoneId, isDragging, isSelected, canDrag, showKeyboard, announce }: {
  item: DragItem;
  zoneId: string;
  isDragging: boolean;
  isSelected: boolean;
