...
/**
 * Hook for managing cookbook timers
 * Handles multiple simultaneous timers with localStorage persistence
 */
export function useCookbookTimer(callbacks?: TimerCallbacks) {
